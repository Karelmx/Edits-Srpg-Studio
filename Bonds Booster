/*
	...
	defense and resistance, but ONLY if there any allies
	nearby them.
	
	How to use:
	- Create a skill with the "custom" radio checked
	- Set the keyword to "Bondsb"
  ...
  Example:
 (scope: 2, power: 5, defense: 5) In this way it grants power and defense +5 if there is any ally within 2 spaces.
...
(function() {
    ...
    // Devuelve true si hay al menos un aliado en el rango, false en caso contrario
    return amount >= 1;
}
	...
	AbilityCalculator.getPower = function(unit, weapon) {
		...
		var skillArray = SkillControl.getDirectSkillArray(unit, SkillType.CUSTOM, "Bondsb");
	...
	DamageCalculator.calculateDefense = function(active, passive, weapon, isCritical, totalStatus, trueHitValue) {
		...
		var skillArray = SkillControl.getDirectSkillArray(passive, SkillType.CUSTOM, "Bondsb");
